...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # as classifier label
       path = "F:\\#07 Programmieren\\Py_Projekte\\Classifier\\pet_images" + str(key) 
       print(path)
...
def main():
    ...
    model = input("Modell festlegen: ") or "resnet" #alexnet, vgg (string)
    image_dir = input("Bitte Pfad eingeben: ") or "F:\\#07 Programmieren\\Py_Projekte\\Classifier\\pet_images"
