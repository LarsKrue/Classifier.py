...
def classify_images(images_dir, results_dic, model):
    ...
    for key, value in results_dic.items():
       dir_= r"F:\07_Programmieren\Py_Projekte\Classifier\pet_images" 
       file_name = str(key)
       path = os.path.join(dir_, file_name)
            
       #print("Path komplett: ", path)
       #print("Key:" ,key)
       #print("Value aus [] Dict:",results_dic[key])
       #print("value aus /  Dict:", value)
       ...
       if value in model_label:
           #print("{} ist enthalten in {}".format(model_label, value))
           correct_identified = 1
           correct_identified = 1
           #print("Erfolg:", correct_identified)
           #print("{} ist in {} enthalten".format(model_label, value))
       else:
           #print("{} ist nicht enthalten in: {}".format(model_label, value))
           correct_identified = 0
           #print("Erfolg:", correct_identified)
           correct_identified = 0
           #print("Erfolg:", correct_identified)
